...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Open+Sans:ital,wght@0,300..800;1,300..800&family=Poppins&family=Roboto:ital,wght@0,100;0,300;0,400;0,500;0,700;0,900;1,100;1,300;1,400;1,500;1,700;1,900&display=swap"
        rel="stylesheet">
    ...
    <main class="hero">
        ...
        <div class="container text-center py-5">
            ...
            <div class="hero-img mx-auto">
                <img src="{{ asset('assets/img/bg.png') }}" class="img-fluid" alt="Inventory" style="width: 500px">
            </div>
        </div>
